def setup_views(container):
    ...
    app.add_url_rule('/api/solutions/<scan_id>/result', methods=['GET'], view_func=container.get_plagiarism_results.as_view())
    app.add_url_rule('/api/management/analyze', methods=['POST'], view_func=container.get_management_analysis.as_view())
